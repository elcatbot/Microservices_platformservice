...
If you want, I can add example request/response JSON payloads for each endpoint or generate an OpenAPI/Swagger fragment from the controllers. Which would you prefer next?
